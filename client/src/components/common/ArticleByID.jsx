...
//               <div>
//                 <p className="display-6 me-4"><b>{state.title}</b></p>
//                 {/* doc & dom */}
...
//           </div>
//           {/* content*/}
//           <p className="lead  fs-6 text-justify article-content bgc p-5" style={{ whiteSpace: "pre-line" }}>
//             {state.content}
//           </p>
//           {/* user commnets */}
//           <div>
...
//               {
//                 state.comments.length === 0 ? <p className='fs-4 text-start'>No comments yet..</p> :
//                   state.comments.map(commentObj => {
//                     return <div key={commentObj._id} >
//                       <img src="" alt="" />
//                       <p className="user-name text-start ">
...
//               <input type="text"  {...register("comment")} className="form-control mb-4 w-50" />
